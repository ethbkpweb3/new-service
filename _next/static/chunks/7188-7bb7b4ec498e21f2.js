"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[7188], {
    47339: function(e, t, n) {
        n.d(t, {
            S: function() {
                return o
            },
            ...
            return {
                parameterizedRoute: t.map(e => {
                    let t = r.INTERCEPTION_ROUTE_MARKERS.find(t => e.startsWith(t))
                      , i = e.match(/\[((?:\[.*\])|.+)\]/);
                    if (t && i) {
                        let {key: e, optional: r, repeat: l} = u(i[1]);
                        return n[e] = {
                            pos: a++,
                            repeat: l,
                            optional: r
                    ...
                    {
                        let {key: e, repeat: t, optional: r} = u(i[1]);
                        return n[e] = {
                            pos: a++,
                            repeat: t,
                            optional: r
